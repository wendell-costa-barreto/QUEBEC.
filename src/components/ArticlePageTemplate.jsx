          ...
          <div className="relative z-10 h-full flex items-center">
            <div className="container mx-auto px-8">
              <div className="max-w-4xl">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-md rounded-full text-white/90 text-sm mb-6 animate-fade-in">
          ...
          <div className="container mx-auto px-8">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                {/* Right Stats */}
                <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-12 lg:p-16">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">{stats.inhabitants}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">{stats.location}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">{stats.elevation}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600">{stats.viewpoint}</div>
                      </div>
                    </div>
                  </div>

                  <div className="mt-8 p-6 bg-white/60 backdrop-blur-sm rounded-xl">
                    ...
                    <div className="text-sm text-gray-600">
                      All year round - perfect for everyone
                    </div>
                  </div>
                </div>
              </div>
